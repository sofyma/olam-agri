...
<div class="game-info-container">
  ...
  <div class="info-content">
    <div class="game-badge">Unit 4</div>
    
    <h1 class="game-title">Choose a Side</h1>
    
    <div class="game-description">
      <p>
        Test your knowledge with our True or False challenge! You'll see 5 statement cards one after another, 
        and you need to swipe LEFT for false statements and RIGHT for true statements.
      </p>
      ...
      <h3>How to play:</h3>
      <p>
        You start with 5 points. For each statement, swipe LEFT if it's false or RIGHT if it's true. 
        Each incorrect swipe costs you 1 point. Think carefully before you swipe - there's no time limit, 
        but accuracy matters! Your goal is to finish with the highest score possible.
      </p>
      ...
      <div class="game-stats">
        ...
        <div class="stat">
          ...
          <span class="stat-label">Point per mistake</span>
        </div>
      </div>
    </div>
